...
% directory = dir('C:\Users\McGill\Documents\GitHub\Remapping-Analysis\Murican events');
% directory = dir('C:\Users\McGill\Documents\GitHub\Remapping-Analysis\Albertan events');
% directory = dir('C:\Users\McGill\Documents\GitHub\Remapping-Analysis\Italian events');
% directory = dir('C:\Users\McGill\Documents\GitHub\Remapping-Analysis\Quebecer events');
directory = dir('C:\Users\McGill\Documents\GitHub\Remapping-Analysis\Winnipeg events');
...
for ifile = 1:length(directory)
    if strfind(directory(ifile).name,'events')
        ...
        button_press_buffer = 1.3; % time in seconds after the saccade offset that the button press is accepted as a correct trial
        
        
        for iCorrSucc1 = 1:length(correct_Button1)
            for iEvent_offset1 = 1:length(event_offset1)
                if correct_Button1(iCorrSucc1) - event_offset1(iEvent_offset1) <button_press_buffer && correct_Button1(iCorrSucc1) - event_offset1(iEvent_offset1)>0.00
        ...
        for iCorrSucc2 = 1:length(correct_Button2)
            for iEvent_offset2 = 1:length(event_offset2)
                if  correct_Button2(iCorrSucc2) - event_offset2(iEvent_offset2) <button_press_buffer && correct_Button2(iCorrSucc2) - event_offset2(iEvent_offset2) >0.00
        ...
        for iFalseButton1 = 1:length(false_Button1)
            for iEvent_offset1 = 1:length(event_offset1)
                if false_Button1(iFalseButton1) - event_offset1(iEvent_offset1) <button_press_buffer && false_Button1(iFalseButton1) - event_offset1(iEvent_offset1) >0.00
        ...
        for iFalseButton2 = 1:length(false_Button2)
            for iEvent_offset2 = 1:length(event_offset2)
                if  false_Button2(iFalseButton2) - event_offset2(iEvent_offset2) <button_press_buffer && false_Button2(iFalseButton2) - event_offset2(iEvent_offset2) >0.00
        ...
        events(endEventsIndex).channels   = cell(1,length(events(endEventsIndex).times));
        events(endEventsIndex).notes      = cell(1,length(events(endEventsIndex).times));
        ...
        save([directory(ifile).folder '\corrected_' directory(ifile).name ],'events')
